...
acronym_option = pd.read_sql('''SELECT Acronym FROM checked_countries WHERE Country == '{}' '''.format(country_option), connection)
st.write('You selected {}-{}'.format(acronym_option[-2:], country_option))
