...
# Printing the coordinators' dataframe
...
st.download_button(label="Download the participants' dataset",data=custom_participants.to_csv().encode('utf-8'), file_name='participants.csv', mime='text/csv')
st.download_button(label="Download the coordinators' dataset",data=coordinators.to_csv().encode('utf-8'), file_name='coordinators.csv', mime='text/csv')
