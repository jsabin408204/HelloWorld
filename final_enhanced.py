...
checked_year = pd.read_sql('''SELECT projects.year AS Year 
FROM participants, projects 
participants.projectID == projects.projectID AND participants.country == '{}'
'''.format(acronym_option), connection)
