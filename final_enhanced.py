...
country_option = st.selectbox('Country:', checked_countries['Country'].unique().sort())
...
year_option = st.selectbox('What year would you like to see?', checked_year['Year'].unique().sort_values())
